  ...
  return (
    ...
    <div className="grid gap-10 lg:grid-cols-2">
      <div>
        ...
        <Link to={props.visit} className="inline-block py-2 px-4 text-white bg-orange-500 hover:bg-orange-600 rounded-full no-underline">
          {props.btnAbout}
        </Link>
      </div>
      <img src={props.imageAbout} alt="Gamer Gaun" className='w-full h-full max-w-md object-contain animate-moveUpDown' />
    </div>
  </div>
