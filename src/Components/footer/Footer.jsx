...
const Footer = () => {
  return (
    <footer className="font-mono mt-10 p-6  max-w-full  bg-stone-300 shadow-md border " >
      <div className="flex ">
      ...
      <div className="flex space-x-6 mt-4    md:mt-0 pl-20">
          <a href="#" aria-label="Facebook" className="text-gray-400 hover:text-gray-300 transition-colors">
            <FaFacebookSquare  className="h-8 w-8 hover:text-gray-500 hover:bg-stone-300" />
          </a>
          <a href="#" aria-label="Twitter" className="text-gray-400 hover:text-gray-300 transition-colors">
            <FiTwitter className="h-8 w-8 hover:text-gray-500 hover:bg-stone-300" />
          </a>
          <a href="#" aria-label="Instagram" className="text-gray-400 hover:text-gray-300 transition-colors">
            <FiInstagram className="h-8 w-8 hover:text-gray-500 hover:bg-stone-300" />
          </a>
          <a href="#" aria-label="LinkedIn" className="text-gray-400 hover:text-gray-300 transition-colors">
            <FiLinkedin className="h-8 w-8 hover:text-gray-500 hover:bg-stone-300 " />
          </a>
        </div>
      </div> 
      <div className="flex space-x-20 pr-20">
        ...
        <NavLink to="/gundrukreads-contactus" className="no-underline  text-slate-700 hover:underline hover:text-red-500">Contact Us</NavLink>
